<html>
	<head>
		...
		<link rel="stylesheet/less" type="text/css" href="less/band.less">
		<script>
			less = {
				async: true
			}
	...
	<body data-spy="scroll" data-target=".navbar" data-offset="50">
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3 shade">
					<h1>What type of music do you play?</h1>
